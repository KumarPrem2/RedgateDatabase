...
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [PK__staffs__1963DD9C2425F160] PRIMARY KEY CLUSTERED ([staff_id]) ON [PRIMARY]
GO
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [UQ__staffs__AB6E61647946EFC4] UNIQUE NONCLUSTERED ([email]) ON [PRIMARY]
GO
